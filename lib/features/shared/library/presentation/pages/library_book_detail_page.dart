    ...
    return Scaffold(
                    ...
                    children: [
                      ...
                      ListView(
                        ...
                        children: [
                          ...
                          buildBookDetailField(
                            label: 'Tahun Terbit',
                            value: '${bookDetail['published_year'] as int}',
                          ),
                          buildBookDetailField(
                            label: 'Kategori',
                          ...
                          buildBookDetailField(
                            ...
                            value: '${bookDetail['total_page'] as int} Hal.',
                          ),
                          buildBookDetailField(
                            label: 'Jumlah Halaman',
      ...
      bottomSheet: Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            if (bookDetail['complete_percentage'] != null) ...[
              Text(
                'Progres Membaca',
              ...
              LinearPercentIndicator(
                ...
                curve: Curves.easeIn,
                percent: (bookDetail['complete_percentage'] as double) / 100,
                progressColor: successColor,
                backgroundColor: secondaryTextColor,
                trailing: Text(
                  '${(bookDetail['complete_percentage'] as double).toInt()}%',
                ),
              ),
            ] else
              Text(
